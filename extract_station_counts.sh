...
mkdir ./data/station_counts
for dir in ./data/RawBikeData2/*; 
do 
	echo ./data/station_counts/counts_${dir:20:4}_${dir:25:2}.csv
	mv $dir/bikeshare_nyc_raw.csv ./data/station_counts/counts_${dir:20:4}_${dir:25:2}.csv
done
